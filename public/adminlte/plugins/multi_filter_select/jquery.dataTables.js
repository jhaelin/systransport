 ...
 * Â©2008-2013 SpryMedia Ltd - datatables.net/license Search: "sSearch":
 */ 
...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "No existe datos en Tabla" )
		{
	...
	function _fnFilterComplete ( oSettings, oInput, iForce )
	{
		...
		_fnCallbackFire( oSettings, null, 'BBBBBB', [oSettings] );
	}
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Viendo _START_ to _END_ of _TOTAL_ hgh",
