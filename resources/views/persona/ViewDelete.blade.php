<div class="modal-header header-danger">
	...
	<h4><center style="font-size:12px; color:white;"><i style="font-size:12px; color:white;" class="fa fa-fw fa-exclamation-triangle danger"></i> ¿Esta seguro de Eliminar Registro del Personal?</center></h4>
</div>
<form id="f11" name="f11" class="" role="form" method="post" action="{{url('/deletPersona')}}" >
	...
	<div  class="modal-body" >
		...
		<div class="row">
			...
			<div class="col-md-8 txt">
				...
				<div class="form-group col-md-6">
					<label class="txt">Cargo:</label> {{$row->cargo}}
				</div>
			</div>

			<div class="col-md-4"><br>
				<!-- <div class="form-group col-md-12"> -->
					<center><img src="{{url('uploads_files/'.$row->foto)}}" class="archivo3" style="height:140px; width:120px"></center>
				<!-- </div> -->
			</div>
	...
	<div class="modal-footer">
		<a class="btn btn-sm btn-outline pull-left" href="{{'../persona'}}" role="button" data-dismiss="modal">Cancelar</a>
